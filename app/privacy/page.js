...
export const metadata = generatePageMeta({
  title: 'Privacy Policy - Game365Hub',
  description: 'Privacy Policy for Game365Hub. Learn how we collect, use, and protect your data when you use our gaming resource website.',
  path: '/privacy',
});
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="space-y-8" style={{ color: 'var(--text-secondary)' }}>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>3. Google Analytics</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>4. Advertising</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>5. Cookies</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>6. Third-Party Services</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>7. Data Security</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>8. Children&apos;s Privacy</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>9. Changes to This Policy</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>10. Contact Us</h2>
          <p>
